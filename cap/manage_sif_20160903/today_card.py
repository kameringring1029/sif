...
if __name__ == '__main__':
	...
	(member_info, fullimg) = useSQL.get_member_info(useSQL.rand_member(2, get_names('')))

	filename = '/home/pi/sif/cap/manage_sif/fullimg.jpg'
	command = "wget '"+str(fullimg)+"' -O "+filename
	...
	useTwitter.post_tweet_image(0,member_info,'/home/pi/sif/cap/manage_sif/fullimg.jpg')
